...
import { buildFormPost, downloadInvoice, estimateEta, fmtMoney, PASSENGER_THEME, toLocPoint, toPoint, useSplash } from "./passengerUtils";
...
export default function PassengerHome() {
  ...
  return (
    <div style={PASSENGER_THEME} className="min-h-screen bg-[linear-gradient(180deg,var(--mb-bg),#fff1f8)] text-[var(--mb-text)]">
      <HeaderBar user={user} activeView={activeView} />
